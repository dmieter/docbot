...
prompt_dpo = """Действуй как высококлассный юрист-секретарь кафедры дополнительного обучения и используй для ответа на вопрос приведенные ниже данные.
      От подробности ответа зависит качество образования в стране!
      Документы: {context}
      Вопрос: {question}; дай четкий ответ. При наличии дай ссылку на документы по программам дополнительного образования.
      Ответ специалиста:"""
